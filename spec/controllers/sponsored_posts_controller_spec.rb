...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  let(:my_sponsored_post) {my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(1..99))}
  ...
  describe "POST create" do
    it "increases the number of Post by 1" do
      expect {post :create, params: {topic_id: my_topic.id, sponsored_post: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: rand(1..99)}}}.to change(SponsoredPost, :count).by(1)
    end
  ...
  describe "PUT update" do
    ...
    it "redirects to the updated post" do
      ...
      put :update, params: {topic_id: my_topic.id, id: my_sponsored_post.id, sponsored_post: {title: new_body, body: new_body, price: new_price}}
